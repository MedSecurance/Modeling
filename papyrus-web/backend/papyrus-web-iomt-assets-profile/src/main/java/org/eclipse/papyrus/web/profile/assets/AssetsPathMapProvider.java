...
/**
 * Pathmap provider used for Assets profile.
 * 
 * @author Pascal Bannerot (CEA LIST) <pascal.bannerot@cea.fr>
 */
@Service
public class AssetsPathMapProvider implements IPathMapProvider {

    @Override
    public List<PathMapMetadata> getPathmaps() {
        return List.of(new PathMapMetadata("IoMTAssets_PROFILE/IoMTAssets.profile.uml", "IoMTAssets.profile.uml"));
    }
