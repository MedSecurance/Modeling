...
public class NonDerivedNonContainmentReferenceIfDescriptionProvider {
    ...
    public IfDescription getIfDescription() {
        return IfDescription.newIfDescription(ID_DESCRIPTION_ID).targetObjectIdProvider(this.semanticTargetIdProvider).predicate(this.getPredicate())
                .controlDescriptions(List.of(this.getReferenceWidgetDescription())).build();
    }
