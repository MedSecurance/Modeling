...
import org.eclipse.papyrus.uml.domain.services.drop.diagrams.ClassInternalSourceToRepresentationDropBehaviorProvider;
import org.eclipse.papyrus.uml.domain.services.drop.diagrams.ClassInternalSourceToRepresentationDropChecker;
...
/**
 * Provides the behavior on a graphical drop event in the "Class" Diagram.
 *
...
public class ClassGraphicalDropBehaviorProvider implements IWebInternalSourceToRepresentationDropBehaviorProvider {
     ...
     *            Logger used to report errors and warnings to the user
     */
    public ClassGraphicalDropBehaviorProvider(IEditingContext editionContext, IViewHelper viewHelper, IObjectService objectService, ECrossReferenceAdapter crossRef,
    ...
    public void handleGraphicalDrop(EObject droppedElement, EObject targetElement, Node droppedNode, Node targetNode) {
        ...
        new GraphicalDropSwitch(optionalTargetNode, optionalOldContainer, optionalNewContainer, this.viewHelper, this.diagramNavigator, droppedNode, this.logger) //
                .withDropChecker(new ClassInternalSourceToRepresentationDropChecker()) //
                .withDropProvider(new ClassInternalSourceToRepresentationDropBehaviorProvider()) //
