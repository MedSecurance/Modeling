...
/**
 * Provides the behavior on a graphical drop event in the "Composite Structure Diagram".
 *
 ...
 */
public class CompositeStructureGraphicalDropBehaviorProvider implements IWebInternalSourceToRepresentationDropBehaviorProvider {
    ...
    public void handleGraphicalDrop(EObject droppedElement, EObject targetElement, Node droppedNode, Node targetNode) {
        ...
        new GraphicalDropSwitch(optionalTargetNode, optionalOldContainer, optionalNewContainer, this.viewHelper, this.diagramNavigator, droppedNode, this.logger) //
                .withDropChecker(new CompositeStructureInternalSourceToRepresentationDropChecker()) //
                .withDropProvider(new CompositeStructureInternalSourceToRepresentationDropBehaviorProvider()) //
