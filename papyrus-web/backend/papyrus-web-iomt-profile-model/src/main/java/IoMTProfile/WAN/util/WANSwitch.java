 ...
 * @generated
 */
public class WANSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case WANPackage.PROXY: {
				Proxy proxy = (Proxy)theEObject;
				T result = caseProxy(proxy);
				if (result == null) result = caseIdentifiableElement(proxy);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WANPackage.DATA_STORE: {
				DataStore dataStore = (DataStore)theEObject;
				T result = caseDataStore(dataStore);
				if (result == null) result = caseIdentifiableElement(dataStore);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
