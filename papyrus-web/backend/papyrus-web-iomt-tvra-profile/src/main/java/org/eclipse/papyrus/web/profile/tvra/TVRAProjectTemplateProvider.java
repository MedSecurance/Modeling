 ...
 */
@Configuration
public class TVRAProjectTemplateProvider implements IProjectTemplateProvider {
    public static final String UML_TVRA_TEMPLATE_ID = "UMLTVRATemplate";

    @Override
    public List<ProjectTemplate> getProjectTemplates() {
        var umlWithPrimitivesTemplate = new ProjectTemplate(
                UML_TVRA_TEMPLATE_ID,"IoMT TVRA Analysis","/images/IoMTTemplate.png ",
