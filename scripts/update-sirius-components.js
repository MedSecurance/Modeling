...
const projects = [
  ...
  "papyrus-web-graphql-schema",
  "papyrus-web-graphql",
  "papyrus-web-spring",
  "papyrus-web-sirius-contributions",
  "papyrus-web-representation-builder",
  "papyrus-web-cpp-profile",
  "papyrus-web-java-profile",
  "papyrus-web-application",
  "papyrus-web-codegen-profile",
  "papyrus-web-transformation-profile",
];
...
for (let index = 0; index < projects.length; index++) {
  ...
  if (startTagIndex !== -1 && endTagIndex !== -1) {
    let newPomXmlContent = pomXmlContent.substring(
      0,
      startTagIndex + "<sirius.components.version>".length
    );
...
childProcess.execSync(updateSiriusComponentsCommand, {
