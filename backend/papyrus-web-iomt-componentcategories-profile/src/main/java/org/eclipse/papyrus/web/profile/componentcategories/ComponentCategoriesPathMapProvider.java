...
/**
 * Pathmap provider used for Component Categories profile.
 * 
 * @author Pascal Bannerot (CEA LIST) <pascal.bannerot@cea.fr>
 */
@Service
public class ComponentCategoriesPathMapProvider implements IPathMapProvider {

    @Override
    public List<PathMapMetadata> getPathmaps() {
        return List.of(new PathMapMetadata("IoMTComponentCategories_PROFILE/IoMTComponentCategories.profile.uml",
                "IoMTComponentCategories.profile.uml"));
    }
