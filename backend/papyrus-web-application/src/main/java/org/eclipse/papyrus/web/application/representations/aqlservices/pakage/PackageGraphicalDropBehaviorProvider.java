...
/**
 * Provides the behavior on a graphical drop event in the "Package" Diagram.
 *
 ...
 */
public class PackageGraphicalDropBehaviorProvider implements IWebInternalSourceToRepresentationDropBehaviorProvider {
     ...
     *            Logger used to report errors and warnings to the user
     */
    public PackageGraphicalDropBehaviorProvider(IEditingContext editionContext, IViewHelper viewHelper, IObjectService objectService, ECrossReferenceAdapter crossRef,
    ...
    public void handleGraphicalDrop(EObject droppedElement, EObject targetElement, Node droppedNode, Node targetNode) {
        ...
        new GraphicalDropSwitch(optionalTargetNode, optionalOldContainer, optionalNewContainer, this.viewHelper, this.diagramNavigator, droppedNode, this.logger) //
                .withDropChecker(new PackageInternalSourceToRepresentationDropChecker()) //
                .withDropProvider(new PackageInternalSourceToRepresentationDropBehaviorProvider()) //
