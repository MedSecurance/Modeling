...
import org.eclipse.papyrus.uml.domain.services.drop.diagrams.ClassExternalSourceToRepresentationDropBehaviorProvider;
import org.eclipse.papyrus.uml.domain.services.drop.diagrams.ClassExternalSourceToRepresentationDropChecker;
...
/**
 * Provides the behavior on a semantic drop event in the "Class" Diagram.
 *
 ...
 */
public class ClassSemanticDropBehaviorProvider implements IWebExternalSourceToRepresentationDropBehaviorProvider {
     ...
     *            Logger used to report errors and warnings to the user
     */
    public ClassSemanticDropBehaviorProvider(IEditingContext editionContext, IViewHelper viewHelper, IObjectService objectService, ECrossReferenceAdapter crossRef, IEditableChecker editableChecker,
    ...
    public void handleSemanticDrop(EObject droppedElement, org.eclipse.sirius.components.diagrams.Node targetNode) {
        ...
        new SemanticDropSwitch(optionalTargetNode, this.viewHelper, this.diagramNavigator, this.logger) //
                .withDropChecker(new ClassExternalSourceToRepresentationDropChecker()) //
                .withDropProvider(new ClassExternalSourceToRepresentationDropBehaviorProvider()) //
