...
/**
 * Provides the behavior on a semantic drop event in the "Component" Diagram.
 *
...
public class ComponentSemanticDropBehaviorProvider implements IWebExternalSourceToRepresentationDropBehaviorProvider {
     ...
     *            Logger used to report errors and warnings to the user
     */
    public ComponentSemanticDropBehaviorProvider(IEditingContext editionContext, IViewHelper viewHelper, IObjectService objectService, ECrossReferenceAdapter crossRef,
    ...
    public void handleSemanticDrop(EObject droppedElement, org.eclipse.sirius.components.diagrams.Node targetNode) {
        ...
        new SemanticDropSwitch(optionalTargetNode, this.viewHelper, this.diagramNavigator, this.logger) //
                .withDropChecker(new ComponentExternalSourceToRepresentationDropChecker()) //
                .withDropProvider(new ComponentExternalSourceToRepresentationDropBehaviorProvider()) //
