...
import org.eclipse.papyrus.web.application.profile.dto.GetStereotypesInput;
import org.eclipse.papyrus.web.application.profile.dto.GetStereotypesSuccessPayload;
...
public class UMLEditingContextStereotypesDataFetcher implements IDataFetcherWithFieldCoordinates<CompletableFuture<List<UMLStereotypeMetadata>>> {

    private final IEditingContextEventProcessorRegistry editingContextEventProcessorRegistry;

    public UMLEditingContextStereotypesDataFetcher(IEditingContextEventProcessorRegistry editingContextEventProcessorRegistry) {
