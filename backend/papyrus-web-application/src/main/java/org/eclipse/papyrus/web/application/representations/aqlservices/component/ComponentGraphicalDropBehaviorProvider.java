...
/**
 * Provides the behavior on a graphical drop event in the "Component" Diagram.
 *
 * @author <a href="mailto:jessy.mallet@obeo.fr">Jessy Mallet</a>
 */
public class ComponentGraphicalDropBehaviorProvider implements IWebInternalSourceToRepresentationDropBehaviorProvider {
     ...
     *            Logger used to report errors and warnings to the user
     */
    public ComponentGraphicalDropBehaviorProvider(IEditingContext editionContext, IViewHelper viewHelper, IObjectService objectService, ECrossReferenceAdapter crossRef,
    ...
    public void handleGraphicalDrop(EObject droppedElement, EObject targetElement, Node droppedNode, Node targetNode) {
        ...
        new GraphicalDropSwitch(optionalTargetNode, optionalOldContainer, optionalNewContainer, this.viewHelper, this.diagramNavigator, droppedNode, this.logger) //
                .withDropChecker(new ComponentInternalSourceToRepresentationDropChecker()) //
                .withDropProvider(new ComponentInternalSourceToRepresentationDropBehaviorProvider()) //
