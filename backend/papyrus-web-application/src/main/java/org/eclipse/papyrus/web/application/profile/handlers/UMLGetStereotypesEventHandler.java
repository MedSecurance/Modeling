 ...
 */
@Service
public class UMLGetStereotypesEventHandler implements IEditingContextEventHandler {
    ...
    public UMLGetStereotypesEventHandler(ICollaborativeMessageService messageService, MeterRegistry meterRegistry, IUMLStereotypeService stereotypeService) {
