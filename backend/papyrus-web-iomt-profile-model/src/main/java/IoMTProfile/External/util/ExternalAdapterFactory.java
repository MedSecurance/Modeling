/**
 */
package IoMTProfile.External.util;

import IoMTProfile.External.*;
...
public class ExternalAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link IoMTProfile.External.Person <em>Person</em>}'.
	 * <!-- begin-user-doc -->
