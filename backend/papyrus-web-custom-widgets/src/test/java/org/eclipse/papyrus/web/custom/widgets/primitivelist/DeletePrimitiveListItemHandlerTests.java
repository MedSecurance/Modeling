...
import org.eclipse.papyrus.web.custom.widgets.primitivelist.handler.DeletePrimitiveListItemEventHandler;
...
/**
 * Unit tests for the delete primitive list item handler.
 *
 * @author Jerome Gout
 */
public class DeletePrimitiveListItemHandlerTests {
    ...
    @Test
    public void testDeletePrimitiveListItemHandler() {
        String itemId = "Item Id";
        String changeKind = ChangeKind.SEMANTIC_CHANGE;

        var input = new DeletePrimitiveListItemInput(UUID.randomUUID(), FORM_ID.toString(), UUID.randomUUID()
        ...
        DeletePrimitiveListItemEventHandler handler = new DeletePrimitiveListItemEventHandler(formQueryService, new ICollaborativeFormMessageService.NoOp(), new SimpleMeterRegistry());
    ...
    @Test
    public void testDeletePrimitiveListItemHandlerReadOnly() {
        String itemId = "Item Id";
        String changeKind = ChangeKind.SEMANTIC_CHANGE;
