...
import org.eclipse.papyrus.web.custom.widgets.containmentreference.handlers.ClickContainmentReferenceItemEventHandler;
...
/**
 * Unit tests for the click containment reference item handler.
 *
 * @author Jerome Gout
 */
public class ClickContainmentReferenceItemHandlerTests {
    ...
    @Test
    public void testClickContainmentReferenceItemHandler() {
        String referenceValueId = "ReferenceValue Id";
        String changeKind = ChangeKind.SEMANTIC_CHANGE;

        var input = new ClickContainmentReferenceItemInput(UUID.randomUUID(), FORM_ID.toString(), UUID.randomUUID()
                .toString(), WIDGET_ID, referenceValueId, ClickEventKind.SINGLE_CLICK);
    ...
    @Test
    public void testClickContainmentReferenceItemHandlerReadOnly() {
        String referenceValueId = "ReferenceValue Id";
        String changeKind = ChangeKind.SEMANTIC_CHANGE;
