...
/**
 * Tests edge creation tools on nodes in containers in the Deployment Diagram.
 *
 * @author <a href="mailto:gwendal.daniel@obeosoft.com">Gwendal Daniel</a>
 */
public class DDSubNodeEdgeCreationTest extends EdgeCreationTest {
    ...
    public DDSubNodeEdgeCreationTest() {
    ...
    public void setUp() {
        ...
        String packageContainerId = packageContainerNode.getId();
        this.createSourceAndTargetNodes(packageContainerId, new CreationTool(ToolSections.NODES, UML.getArtifact()));
        this.createSourceAndTargetNodes(packageContainerId, new CreationTool(ToolSections.NODES, UML.getConstraint()));
        this.createSourceAndTargetNodes(packageContainerId, new CreationTool(ToolSections.NODES, UML.getDeploymentSpecification()));
        this.createSourceAndTargetNodes(packageContainerId, new CreationTool(ToolSections.NODES, UML.getDevice()));
        this.createSourceAndTargetNodes(packageContainerId, new CreationTool(ToolSections.NODES, UML.getExecutionEnvironment()));
        this.createSourceAndTargetNodes(packageContainerId, new CreationTool(ToolSections.NODES, UML.getModel()));
        this.createSourceAndTargetNodes(packageContainerId, new CreationTool(ToolSections.NODES, UML.getNode()));
        this.createSourceAndTargetNodes(packageContainerId, new CreationTool(ToolSections.NODES, UML.getPackage()));
    }
